...
<%@ page
	import="com.jspsmart.upload.*,com.jspsmart.file.*,com.neo.utils.*,  java.io.BufferedReader,  java.io.File,java.sql.Statement, java.io.FileInputStream,  java.io.FileOutputStream,  java.io.IOException,  java.io.InputStreamReader,  java.sql.Statement,  java.sql.Connection,  java.sql.ResultSet,  java.sql.SQLException,  java.util.zip.ZipEntry,  java.util.zip.ZipInputStream,  java.util.zip.ZipOutputStream, neo.velocity.common.Utility,  oracle.jdbc.OracleTypes,  com.github.junrar.exception.RarException, com.github.junrar.impl.FileVolumeManager, com.github.junrar.rarfile.FileHeader, com.github.junrar.Archive, org.apache.poi.xssf.usermodel.XSSFCell, org.apache.poi.xssf.usermodel.XSSFRow, org.apache.poi.xssf.usermodel.XSSFSheet, org.apache.poi.xssf.usermodel.XSSFWorkbook, org.apache.poi.poifs.filesystem.POIFSFileSystem,  org.apache.poi.hssf.usermodel.HSSFCell, org.apache.poi.hssf.usermodel.HSSFRow, org.apache.poi.hssf.usermodel.HSSFSheet, org.apache.poi.hssf.usermodel.HSSFWorkbook, com.linuxense.javadbf.DBFField, com.linuxense.javadbf.DBFWriter "%>

<%@page import ="javax.xml.parsers.SAXParser,javax.xml.parsers.SAXParserFactory,javax.xml.parsers.SAXParser,
...
<%@page import="org.apache.poi.openxml4j.exceptions.OpenXML4JException,org.apache.poi.openxml4j.exceptions.InvalidFormatException,
					...
					if(resultWriteFile.length() > 0){
						...
						if(extFileName.equals(".xls") && UPLOAD_FILE_TYPE == 0){
							...
							result = insertXlsData(rootFolder + duLieuThueFolder
								+ resultWriteFile, SHEET_NUMB - 1, excelType,mParams);
  						}else if(extFileName.equals(".xlsx") && UPLOAD_FILE_TYPE == 0){
							excelType = 1;
							result = insertXlsData(rootFolder + duLieuThueFolder
								+ resultWriteFile, SHEET_NUMB, excelType,mParams);
						}
						//Upload dữ liệu thanh toán
						if(extFileName.equals(".xls") && UPLOAD_FILE_TYPE == 1){
 							result = getNumbXlsColumn(rootFolder+duLieuThanhToanFolder + resultWriteFile,SHEET_NUMB -1);
						}
...
<%!
	...
	public String insertXlsData(String fileName, int sheetNum, int excelType,HashMap<String, String> mParams) {
		String result = "";
		String sql = "insert into tax.nnts_uploads_temp(mcq,ma_unt,ten_unt,cbk_unt,ngay_unt,ma_nnt,ten_nnt,sac_thue,chuong,tieu_muc,dia_ban,kbnn,kythue,loaitk_nsnn,han_nop,magiao_unt,loai_tien,tien_giao,tien_con,tien_thuduoc,tien_quyettoan,so_bl,ngay_bl,sobl_unt,ngaybl_unt,ngay_banke,sonha_ct,matinh_ct,tentinh_ct,maquan_ct,tenquan_ct,maxa_ct,tenxa_ct,mobile,email,sonha_tt,matinh_tt,tentinh_tt,maquan_tt,tenquan_tt,maxa_tt,tenxa_tt,id,ma_tinh,log_user,log_ip,log_date) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,'"+mParams.get("ma_tinh")+"','"+mParams.get("user")+"','"+mParams.get("user_ip")+"',sysdate)";
		// String sqlDelTable =
	...
	public String readFileExcelXLSX(String fileName, int numSheet,long mySEQ)
			throws IOException {
		String result = "";
	...
	private String processSheet(StylesTable styles,
		...
		return "{RESULT:'OK',VALUE:'Upload success!'}";
	}
