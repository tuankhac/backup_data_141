	   ...
	   <div id="r_parent" style="overflow: hidden;" >
		  <div  style="width: 47%;float: left;">
			 ...
			 <div class="box-header with-border">
				<h3 class="box-title" style="font-weight:bold;color:#039">DANH SÁCH REQUEST FILE</h3>
		  ...
		  <div style="width: 47%;float: right;" >
			 ...
			 <div class="box-header with-border">
				<h3 class="box-title" style="font-weight:bold;color:#039">DANH SÁCH RESPONSE FILE</h3>
				<div class="box-tools"></div>
			 </div>
			 <div class="box box box-primary">
...
<%!//lay danh sach cac file thoa man
	...
	private String[] checkFile(File file, String from_date, String to_date, String id_filter) {
		...
		try {
			...
			if (dateOfFile.before(dateT) && dateOfFile.after(dateF)) {
